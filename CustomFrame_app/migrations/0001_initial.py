# Generated by Django 5.2.3 on 2025-07-23 06:45
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('width', models.IntegerField(blank=True, default=20, null=True)),
                ('mack_board', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='CustomFrame_app.mackboard')),
                ('saved_item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='CustomFrame_app.saveditem')),
            ],
        ),
        migrations.AddField(
            model_name='saveditem',
            name='mack_boards',
            field=models.ManyToManyField(blank=True, through='CustomFrame_app.SavedItemMackBoard', to='CustomFrame_app.mackboard'),
        ),
        migrations.CreateModel(
            name='SizeVariant',
            fields=[
